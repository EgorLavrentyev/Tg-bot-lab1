...
ikb_file = InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton('Прикрепить файл', callback_data='with_file')],[InlineKeyboardButton('Продолжить без файла', callback_data='without_file')]])
...
ikb_edit_menu = InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton('Описание', callback_data='edit_description'),
                                                      InlineKeyboardButton('Дата', callback_data='edit_notice_date'),
...
ikb_files = InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton('Добавить еще файлы', callback_data='add_more_files'),
                                                   InlineKeyboardButton('Продолжить', callback_data='end_add_files')]])
